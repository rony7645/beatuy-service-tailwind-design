...
const Banner = () => {
  return (
    <>
      <section className="hero py-10 md:py-16 lg:h-screen bg-[url('public/images/hero-9.jpg')] bg-left md:bg-center bg-no-repeat bg-cover flex flex-col justify-center">
        <div className="container-layout">
          <div className="hero-wrapper flex flex-col gap-5 w-3/4 lg:w-2/3 text-center lg:text-left mx-auto lg:mx-0">
            ...
            <Button name="Find Out More" className="bg-accent text-light hover:text-accent mt-5 border-primary"/>
          </div>
        </div>
      </section>
    </>
